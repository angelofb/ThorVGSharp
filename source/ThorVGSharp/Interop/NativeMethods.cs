...
internal static unsafe partial class NativeMethods
{
    ...
    [DllImport("thorvg", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern Tvg_Result tvg_paint_set_transform([NativeTypeName("Tvg_Paint")] _Tvg_Paint* paint, [NativeTypeName("const Tvg_Matrix *")] Tvg_Matrix* m);

    [DllImport("thorvg", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern Tvg_Result tvg_paint_get_transform([NativeTypeName("Tvg_Paint")] _Tvg_Paint* paint, Tvg_Matrix* m);
    ...
    [DllImport("thorvg", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern Tvg_Result tvg_paint_get_obb([NativeTypeName("Tvg_Paint")] _Tvg_Paint* paint, Tvg_Point* pt4);
    ...
    [DllImport("thorvg", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern Tvg_Result tvg_shape_append_path([NativeTypeName("Tvg_Paint")] _Tvg_Paint* paint, [NativeTypeName("const Tvg_Path_Command *")] byte* cmds, [NativeTypeName("uint32_t")] uint cmdCnt, [NativeTypeName("const Tvg_Point *")] Tvg_Point* pts, [NativeTypeName("uint32_t")] uint ptsCnt);

    [DllImport("thorvg", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern Tvg_Result tvg_shape_get_path([NativeTypeName("const Tvg_Paint")] _Tvg_Paint* paint, [NativeTypeName("const Tvg_Path_Command **")] byte** cmds, [NativeTypeName("uint32_t *")] uint* cmdsCnt, [NativeTypeName("const Tvg_Point **")] Tvg_Point** pts, [NativeTypeName("uint32_t *")] uint* ptsCnt);
    ...
    [DllImport("thorvg", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern Tvg_Result tvg_gradient_set_color_stops([NativeTypeName("Tvg_Gradient")] _Tvg_Gradient* grad, [NativeTypeName("const Tvg_Color_Stop *")] Tvg_Color_Stop* color_stop, [NativeTypeName("uint32_t")] uint cnt);

    [DllImport("thorvg", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern Tvg_Result tvg_gradient_get_color_stops([NativeTypeName("const Tvg_Gradient")] _Tvg_Gradient* grad, [NativeTypeName("const Tvg_Color_Stop **")] Tvg_Color_Stop** color_stop, [NativeTypeName("uint32_t *")] uint* cnt);
    ...
    [DllImport("thorvg", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern Tvg_Result tvg_gradient_set_transform([NativeTypeName("Tvg_Gradient")] _Tvg_Gradient* grad, [NativeTypeName("const Tvg_Matrix *")] Tvg_Matrix* m);

    [DllImport("thorvg", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern Tvg_Result tvg_gradient_get_transform([NativeTypeName("const Tvg_Gradient")] _Tvg_Gradient* grad, Tvg_Matrix* m);
